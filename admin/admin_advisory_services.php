...
<?php
include('dbcon.php');
$sql = "select * from advisory_services";
...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">advisory services</h1>
        <ol class="breadcrumb">
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="edit_advisory_services.php?id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit/Add Details</a></td>
