...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">Data Services </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="dashboard.php"><i class="la la-home font-20"></i></a>
            </li>

            <li class="breadcrumb-item">Data Services Page</li>
        </ol>
    </div>
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="edit_data_services.php?id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit/Add Details</a></td>
