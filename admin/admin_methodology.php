...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">methodology Page</li>
        </ol>
    </div>
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="edit_methodology.php?id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit/Add Details</a></td>
