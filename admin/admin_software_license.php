...
<?php
include('dbcon.php');
$sql = "select * from software_license_management";
...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">itam services </h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="dashboard.php"><i class="la la-home font-20"></i></a>
            </li>

            <li class="breadcrumb-item">itam services Page</li>
        </ol>
    </div>
                        ...
                        ?>
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="edit_software_license.php?id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-edit"></i> Edit/Add Details</a></td>
