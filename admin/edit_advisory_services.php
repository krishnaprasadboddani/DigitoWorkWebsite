...
include('dbcon.php');
$id = $_GET['id'];
$sqlqry = "select * from advisory_services where id='$id'";
...
<div class="content-wrapper">
    ...
    if (isset($_POST['submit'])) {
        ...
        $id = $_POST['id'];
        $sql_update = "update advisory_services set p1='$p1', p2='$p2', p3='$p3',p4='$p4',p5='$p5',p6='$p6',p7='$p7', p8='$p8' where id='$id'";
        $update = mysqli_query($con, $sql_update);



        if ($_FILES['image1']['name']) {
            $update = mysqli_query($con, "update advisory_services set image1='" . $_FILES['image1']['name'] . "' where id=" . $id);
        }
        if ($_FILES['image2']['name']) {
            $update = mysqli_query($con, "update advisory_services set image2='" . $_FILES['image2']['name'] . "' where id=" . $id);
        }
