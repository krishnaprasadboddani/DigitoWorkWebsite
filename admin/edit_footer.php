...
include('dbcon.php');
$id = $_GET['id'];
$sqlqry = "select * from footer where id='$id'";
...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">Footer Page</h1>
        <ol class="breadcrumb">
    ...
    if (isset($_POST['submit'])) {
        ...
        $id = $_POST['id'];
        $sql_update = "update footer set p1='$p1', p2='$p2', p3='$p3' where id='$id'";
    ...
    ?>
            <script>
                ...
                window.open('admin_footer.php', '_self');
            </script>
    <?php
        }
    }
