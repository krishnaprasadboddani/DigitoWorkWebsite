...
include('dbcon.php');
$id = $_GET['id'];
$sqlqry = "select * from products_pure where id='$id'";
...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">Pure Data Page</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="dashboard.php"><i class="la la-home font-20"></i></a>
            </li>
            <li class="breadcrumb-item">Pure Data</li>
        </ol>
    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <h6>Heading</h6>
                                        <textarea class="form-control" name="p111" rows="3"> <?php echo $row['p111']; ?></textarea>
    ...
    if (isset($_POST['submit'])) {
        ...
        $id = $_POST['id'];
        $sql_update = "update products_pure set p1='$p1',p111='$p111', p2='$p2', p3='$p3',p4='$p4',p5='$p5',p6='$p6',p7='$p7', p8='$p8',p9='$p9', p10='$p10', p11='$p11',p12='$p12',p13='$p13',p14='$p14',p15='$p15' where id='$id'";
        $update = mysqli_query($con, $sql_update);



        if ($_FILES['image1']['name']) {
            $update = mysqli_query($con, "update products_pure set image1='" . $_FILES['image1']['name'] . "' where id=" . $id);
        }
        if ($_FILES['image2']['name']) {
            $update = mysqli_query($con, "update products_pure set image2='" . $_FILES['image2']['name'] . "' where id=" . $id);
        }
        if ($_FILES['image3']['name']) {
            $update = mysqli_query($con, "update products_pure set image3='" . $_FILES['image3']['name'] . "' where id=" . $id);
        }
        if ($update) {
    ?>
            <script>
                alert('Data Updated Successfully');
                window.open('admin_pure.php', '_self');
            </script>
    <?php
        }
    }
