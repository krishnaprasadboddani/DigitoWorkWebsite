...
include('dbcon.php');
$id = $_GET['id'];
$sqlqry = "select * from service_desk where id='$id'";
...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <h1 class="page-title">service desk Page</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="dashboard.php"><i class="la la-home font-20"></i></a>
            </li>
            <li class="breadcrumb-item">service desk</li>
        </ol>
    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $id = $_POST['id'];
        $sql_update = "update service_desk set p1='$p1', p2='$p2', p3='$p3' ,p4='$p4',p5='$p5',p6='$p6',p7='$p7', p8='$p8',p9='$p9', p10='$p10', p11='$p11',p12='$p12',p13='$p13',p14='$p14',p15='$p15'where id='$id'";
        $update = mysqli_query($con, $sql_update);



        if ($_FILES['image1']['name']) {;
            $update = mysqli_query($con, "update service_desk set image1='" . $_FILES['image1']['name'] . "' where id=" . $id);
        }
        if ($update) {
    ?>
            <script>
                alert('Data Updated Successfully');
                window.open('admin_service_desk.php', '_self');
            </script>
    <?php
        }
    }
