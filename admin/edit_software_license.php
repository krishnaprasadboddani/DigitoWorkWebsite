...
include('dbcon.php');
$id = $_GET['id'];
$sqlqry = "select * from software_license_management where id='$id'";
...
<div class="content-wrapper">
    ...
    if (isset($_POST['submit'])) {
        ...
        $id = $_POST['id'];
        $sql_update = "update software_license_management set p1='$p1', p2='$p2', p3='$p3',p4='$p4',p5='$p5',p6='$p6',p7='$p7', p8='$p8',p9='$p9', p10='$p10', p11='$p11',p12='$p12',p13='$p13',p14='$p14',p15='$p15',p15='$p15',p16='$p16',p17='$p17',p18='$p18' where id='$id'";
        $update = mysqli_query($con, $sql_update);



        if ($_FILES['image1']['name']) {
            $update = mysqli_query($con, "update software_license_management set image1='" . $_FILES['image1']['name'] . "' where id=" . $id);
        }
		if ($_FILES['image2']['name']) {
            $update = mysqli_query($con, "update software_license_management set image2='" . $_FILES['image2']['name'] . "' where id=" . $id);
        }
        if ($_FILES['image3']['name']) {
            $update = mysqli_query($con, "update software_license_management set image3='" . $_FILES['image3']['name'] . "' where id=" . $id);
        }
		if ($_FILES['image4']['name']) {
            $update = mysqli_query($con, "update software_license_management set image4='" . $_FILES['image3']['name'] . "' where id=" . $id);
        }
    ...
    ?>
            <script>
                ...
                window.open('admin_software_license.php', '_self');
            </script>
    <?php
        }
    }
