...
--
-- Host: localhost:3306
-- Generation Time: Aug 11, 2020 at 07:53 AM
...
INSERT INTO `experienceform` (`id`, `name`, `middlename`, `lastname`, `dateofbirth`, `gender`, `email`, `phone`, `qualification`, `coursename`, `yop`, `per`, `critical`, `primarys`, `cl`, `pl`, `company_name`, `start`, `end`, `skills`, `domain_experiece`, `file`, `upload_date`) VALUES
