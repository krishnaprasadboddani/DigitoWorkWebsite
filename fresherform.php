	...
	<!--Page Title-->
     <section class="page-title" style="background-image:url(images/background/2.jpg)">
       <div class="auto-container">
           <h4 style="text-align:center;color:white">Build your career</h4>
...
<div class="container">
    	<div class="positions" style="text-align: center;">
    	    <h2 style="text-align:center">Entry Level Form</h2>
        	<!-- <h3>Fill form to apply</h3> php2/contact.php-->
        </div>
...
">
        	...
        	<div class="container">
        		<div class="row">
        			<div class="col-lg-12">
        				<form class="row call_back_form" action="php2/contact.php" method="post" id="contactForm" enctype="multipart/form-data" >
						...
						event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" id="name" name="lastname" placeholder="Last Name" required >
							...
							<div class="form-group col-lg-6">
								...
								<select class="discuss" name="gender" style="display: block;" required>
		...
		<div class="form-group name-group">
          ...
          <!--<div class="palceholder">
            <label for="name">Mobile Number</label>
							...
							<div class="form-group column col-lg-12 col-md-12 col-sm-12">
				...
				<div class="table-responsive">
						<table class="table table-bordered" id="dynamic_fields">
							<tr>
								...
								<td>
								    	<label>Degree/Qualification</label>  <span class="star">*</span>
          ...
          <!--<div class="palceholder">
            ...
            <span class="star">*</span>
								<select class="discuss" name="passyear[]" style="display: block;" required>
            ...
            <span class="star">*</span>   
								<select class="discuss" name="cl" style="display: block;" required>
            ...
            <span class="star">*</span>
								<select class="discuss" name="aoi" style="display: block;" required >
								<option value="">--Area of Interest--</option>
								<option value="Data_Migration">Data Migration</option>
								<option value="Data_Sciences">Data Sciences(AI, ML)</option>
								<option value="Data_Reporting_Visualization">Data Reporting & Visualization</option>
								<option value="Others">Others</option>
								</select>
							</div>
