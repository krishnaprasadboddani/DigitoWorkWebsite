...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>
   ...
   <section class="page-title" style="background-image:url(images/background/2.jpg)">
       <div class="auto-container">
           <h4 style="text-align:center;color:white">Learn to Apply</h4>
...
<div class="container">
    <div class="container-inner">
    	<div class="positions" style="text-align: center;">
    	     <h2 style="text-align:center">Internship Form</h2>
...
">
        	<div class="container">
        		<div class="row">
        			<div class="col-lg-12">
        				<form class="row call_back_form" action="php1/contact.php" method="post" id="contactForm" enctype="multipart/form-data" >
