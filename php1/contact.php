...
if(isset($_POST['submit']))
{
  ...
  $aoi = $_POST['aoi'];
   ...
   $file = $_FILES['file']['name'];
    ...
    $folder = '../file-internship/';
    
     move_uploaded_file($tempname, "../file-internship/$file");
...
if (isset($email) && isset($name)) {
  ...
  $msg      = 'Hello Admin, <br/> <br/> Here are new application from the Internship Form details:';
...
$mail->addAttachment("../file-internship/".$_FILES['file']['name']);
...
$insert_query = "INSERT INTO intertform(name, middlename, lastname, dateofbirth, gender, email, phone, qualification, coursename, yop, per, cl, aoi, file, upload_date) VALUES('$name', '$middlename', '$lastname', '$dateofbirth', '$gender', '$email', '$phone', '$qui', '$coursenm', '$year', '$percen', '$cl', '$aoi', '$file', '$timestamp')";
...
if($result == 1)
  {
    ...
    window.location.href='../intentform.php'</script>
    <?php
    }
    else
    {
