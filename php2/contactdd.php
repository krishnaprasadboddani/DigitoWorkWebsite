...
$to    = "navaneethas26@gmail.com"; // <--- Your email ID here  navaneethas26@gmail.com

$server_email = 'farm@navaneetha.co';  // Your server email to authenticate outgoing emails. eg: name@yourdomain.com
